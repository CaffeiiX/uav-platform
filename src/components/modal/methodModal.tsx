...
const MethodModal: React.FC<{
  ...
  setPlatformSelectUavList: (c: PlatformUav) => void;
}> = ({
  method,
  isPlatformPoint,
  platformPoint,
  ...
  const [selectSingleUav, setSelectSingleUav] = useState('');
      ...
      <>
        <div style={{ width: "100%", marginTop: 10 }}>
          ...
          <Radio.Group
            ...
            value={platformMode}
            disabled={isPlatformPoint.isDrawPoint}
          >
        ...
        <div>
          ...
          <Select
            ...
            onChange={(e) => {
              ...
              setSelectSingleUav(e);
            }}
            value={selectSingleUav}
          >
            {
